 ...
 * @author chalitha
 */
public class ProductDeatils extends javax.swing.JDialog {


    public ProductDeatils(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SideEffect");
        jLabel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 51, 51), 2, true));
        ...
        jTextArea2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 51, 51), 2, true));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProductDeatils dialog = new ProductDeatils(new javax.swing.JFrame(), true);
