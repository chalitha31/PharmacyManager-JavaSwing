 ...
 * @author chalitha
 */
public class LessStock extends javax.swing.JDialog {

    /**
     * Creates new form OutOfStock
     */
    public LessStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadstock();
    }
...
//                            if ( lg >  5) {
            ...
            ResultSet rs = MySQL.search("SELECT DISTINCT `product_img`.`image`, `stock`.`id`,`product`.`id`,`category`.`name`,`brand`.`name`,`product`.`name`,"
                    ...
                    + " INNER JOIN `category` ON `product`.`category_id` = `category`.`id` INNER JOIN  `product_img` ON `product`.`image_id` = `product_img`.`id` WHERE `stock`.`quantity` < '"+20+"' AND `stock`.`quantity` > '"+0+"' ORDER BY `product`.`name` ASC");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><u>Less than 20 items </u> </html>");
...
//        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            //   String filePath = "src//report//stock.jrxml";
             ...
             InputStream filePath = LessStock.class.getResourceAsStream("/report/lessstock.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LessStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LessStock dialog = new LessStock(new javax.swing.JFrame(), true);
