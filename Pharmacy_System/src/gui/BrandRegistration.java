...
public class BrandRegistration extends javax.swing.JFrame {
    ...
    public BrandRegistration(Home h) {
        initComponents();
        loadBrand();
        this.h = h;
    ...
    public void loadBrand(String text) {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `brand` WHERE `name` LIKE '" + text + "%' ORDER BY `name` ASC");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><u>Brand</u></html>");
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            jLabel4.setText("Please enter Brand name");
